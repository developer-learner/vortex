# ERD-DELTA v15 — vortex: engine-wrapper inventory (operator visibility)
...
New criteria introduced by this milestone (PRD v15):
...
New frozen files pin the v15 behavior:
